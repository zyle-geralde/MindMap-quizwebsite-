...
<body class="mainbody">
    <div class="mainhead">
        ...
        <div class="showCW" style="font-size: 30px; margin-right: 100px; color: white; opacity: 0;">
            CORRECT
        </div>
        <div style="display: flex; flex-direction: row; margin-right: 100px; font-size: 25px;">
            <div style="margin-right: 5px; color: rgb(255, 221, 227);">
                SCORE:
            </div>
            <div style="color: white;" class="scorecount">
                0
            </div>
        </div>
    </div>
            ...
            border-radius: 20px; align-items: start; padding: 40px;">
                <div style="font-size: 18px;" class = "forscore">
                    <div style="display: flex; font-size: 22px; color: rgb(255, 221, 227); margin-bottom: 20px;">
                        ...
                        <div style="word-break: break-all;" class="QuestionContainer">
                    ...
                    <div>
                        <div style="display: flex; flex-direction: row; margin-bottom: 10px; align-items: center;">
                            <div style="margin-right: 10px; border-style: solid; border-radius: 1000px; min-width: 32px; flex-direction: row;
                            display: flex; justify-content: center; color: rgb(255, 221, 227);" class="ChA">
                                A
                            </div>
                            <div style="color: white; word-break: break-all;" class="ChAH">
                                jadnfkjsandfkjasdnfkjasndkfjnaskjdnflasfdjashjkdfajskdfhkjsahdfkjsahdfjkasdhfkjhsdjkfahsjkdfhasjkfhjkasdhfkjsafdhkjasfdhsdakj
                                akjsdhfkjashdfkjsahdfjksadhfkjashdkjfhsadkjfhsajkdfhsajkdfhsjkafhjksadhfkjsafdhsjkadfhkjashfkjsafhkjsafhkjas
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div style="display: flex; flex-direction: row; margin-bottom: 10px; align-items: center;">
                            <div style="margin-right: 10px; border-style: solid; border-radius: 1000px; min-width: 32px; flex-direction: row;
                            display: flex; justify-content: center; color: rgb(255, 221, 227);" class="ChB">
                                B
                            </div>
                            <div style="color: white; word-break: break-all;" class="ChBH">
                                jadnfkjsandfksafhkjsafhkjas
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div style="display: flex; flex-direction: row; margin-bottom: 10px; align-items: center;">
                            <div style="margin-right: 10px; border-style: solid; border-radius: 1000px; min-width: 32px; flex-direction: row;
                            display: flex; justify-content: center; color: rgb(255, 221, 227);" class="ChC">
                                C
                            </div>
                            <div style="color: white; word-break: break-all;" class="ChCH">
                                jadnfkjsandfkjasdnfkjasndkfjnaskjdnflasfdjashjkdfajskdfhkjsahdfkjsahdfjkasdhfkjhsdjkfahsjkdfhasjkfhjkasdhfkjsafdhkjasfdhsdakj
                                akjsdhfkjashdfkjsahdfjksadhfkjashdkjfhsadkjfhsajkdfhsajkdfhsjkafhjksadhfkjsafdhsjkadfhkjashfkjsafhkjsafhkjas
                            </div>
                        </div>
                    ...
                    <div>
                        <div style="display: flex; flex-direction: row; margin-bottom: 10px; align-items: center;">
                            <div style="margin-right: 10px; border-style: solid; border-radius: 1000px; min-width: 32px; flex-direction: row;
                            display: flex; justify-content: center; color: rgb(255, 221, 227);" class="ChD">
                                D
                            </div>
                            <div style="color: white; word-break: break-all;" class="ChDH">
                                jsadf
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div style="display: flex; flex-direction: row; margin-bottom: 10px; align-items: center; font-size: 20px; opacity: 0;" class="showAns">
                            <div style="margin-right: 10px;flex-direction: row;
                            display: flex; justify-content: center; color:rgb(6, 215, 132);" class="Anslbl">
                                Answer
                            </div>
                            <div style="color: white; word-break: break-all; border-bottom-style: solid; border-bottom-color: rgb(6, 215, 132);" class="Anshold">
                                Hello
                            </div>
                        </div>
                    </div>
