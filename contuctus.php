...
<body>
    ...
    <div class = headme>
        ...
        <div class = "insideword">
            ...
            <div class = descme>We love to hear from you, This is how you can reach us!</div>
        </div>
        <div class = darkback>
    ...
    <div class = centerme>
        <div class = contacts>
            <div class = "c1">
                <img src="./images/mycollection (1)/png/002-call.png" class = "picicon">
            ...
            <div class = "c1">
                <img src="./images/mycollection (1)/png/003-chat-bubbles.png" class = "picicon">
            ...
            <div class = "c1">
                <img src="./images/mycollection (1)/png/001-email.png" class = "picicon">
            ...
            <div class = "c1">
                <img src="./images/mycollection (1)/png/004-saving.png" class = "picicon">
